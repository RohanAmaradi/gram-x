  ...
  return (
    <div className="p-4 space-y-6">
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-primary mb-1">Equipment Rental</h1>
        <p className="text-sm text-muted-foreground">Find tractors, harvesters, and tools near you.</p>
      </header>
