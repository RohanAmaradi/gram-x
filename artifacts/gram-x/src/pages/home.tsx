  ...
  return (
    <div className="p-4 pb-20 space-y-6">
      <header className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-primary">Ram Ram, Kisan!</h1>
          <p className="text-sm text-muted-foreground">Here is your farm's overview today.</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Card className="bg-card text-card-foreground">
            <CardHeader className="pb-2 pt-4 px-4">
              <CardTitle className="text-xs font-medium flex items-center gap-2 text-muted-foreground">
                <Activity className="w-4 h-4 text-destructive" /> Expenses
              </CardTitle>
            </CardHeader>
            <CardContent className="px-4 pb-4">
          ...
          <Card className="bg-card text-card-foreground">
            <CardHeader className="pb-2 pt-4 px-4">
              <CardTitle className="text-xs font-medium flex items-center gap-2 text-muted-foreground">
                <Sprout className="w-4 h-4 text-primary" /> Active Crops
              </CardTitle>
            </CardHeader>
            <CardContent className="px-4 pb-4">
          ...
          <Card className="bg-card text-card-foreground">
            <CardHeader className="pb-2 pt-4 px-4">
              <CardTitle className="text-xs font-medium flex items-center gap-2 text-muted-foreground">
                <Bird className="w-4 h-4 text-accent" /> Livestock
              </CardTitle>
            </CardHeader>
            <CardContent className="px-4 pb-4">
      ...
      {summary?.weatherAlert && (
        <Card className="bg-accent/20 border-accent/30">
          <CardContent className="p-4 flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-sm text-foreground">Weather Alert</p>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            { href: "/market", icon: IndianRupee, label: "Mandi" },
            { href: "/schemes", icon: ShieldCheck, label: "Schemes" },
            { href: "/equipment", icon: Tractor, label: "Rentals" },
            { href: "/crop-advisor", icon: Leaf, label: "Advisor" },
          ].map((item, i) => (
      ...
      <Card className="bg-primary/5 border-primary/10 relative overflow-hidden">
        ...
        <CardContent className="p-6 relative z-10">
          <h3 className="text-lg font-bold text-primary mb-2">Daily Farming Tip</h3>
          <p className="text-sm text-muted-foreground mb-4">
            Soil moisture is optimal right now. Wait 2 more days before the next irrigation cycle to promote deeper root growth in your wheat crop.
          </p>
          <Link href="/ai">
